...
import static com.age.ui.UI.syslog;
...
public class DescriptionGenerator {
	...
	public List<String> getQuotes(String keyword) throws FileNotFoundException, UnsupportedEncodingException, InterruptedException {
		syslog.log("Generating quotes for " + keyword);
		...
		try {
			...
			syslog.log("Failed when getting quotes", e);
		}
		syslog.log("Done generating quotes for " + keyword);
		syslog.log("Got " + allQuotes.size() + " quotes");
		return allQuotes;
	}
